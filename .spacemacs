...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(fish-completion bash-completion yasnippet-snippets)
...
before packages are loaded."
  ...
  ;; Disabled page-break-lines-completely
  ;;(global-page-break-lines-mode -1)
  ;;(setq page-break-lines-modes nil)
  ;;(add-hook 'org-roam-mode-hook (lambda () (global-page-break-lines-mode -1)))
